    ...
    .registration-form__fields
      .registration-form__field
        ...
        form-input(
          ...
          :error="$v.form.confirmation_auth.$error || confirmation_authError ||  errors.hasOwnProperty('email') || errors.length"
      ...
      .registration-form__field
        ...
        form-input(
          ...
          :error="$v.form.password.$error ||  errors.hasOwnProperty('password') || errors.length"
