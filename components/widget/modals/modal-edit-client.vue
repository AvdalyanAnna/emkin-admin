        ...
        .section-user__column.section-user__column_right
          ...
          .section-user__settings
            .section-user__settings-list
              ...
              user-change-phone.section-user__settings-field(isClient @save="handleLoad" :user="client" :edit="changePhone" @edit="(val)=>changePhone=val")
...
export default {
    ...
    clientList() {
      if (this.client) {
        return [
          ...
          {
            label: 'Date register',
            text: this.format(new Date(this.$newDate(this.client.created_at)), 'dd/MM/yyyy')
          },
          {
            label: 'ID',
            text: this.client.id || '-'
      ...
      return [
        {
          ...
          value: this.client && this.client.first_name ? this.client.first_name : '',
          modalName: 'first_name'
        },
        {
          label: 'Last name',
          placeholder: 'Bairamov',
          value: this.client && this.client.last_name ? this.client.last_name : '',
          modalName: 'last_name'
        },
        {
          label: 'Email',
  ...
  methods: {
    ...
    getClient() {
      this.$axios.$get(`/admin/commercial/clients/${this.clientId}`).then(({data}) => {
        this.client = data
