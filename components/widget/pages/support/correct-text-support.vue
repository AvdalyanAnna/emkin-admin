<template lang="pug">
  form#correct-text__section-form.correct-text__section-list(v-if="loading"  :key="key")
    ...
    .correct-text__section
      .correct-text__row.flex
        .correct-text__column.correct-text__column_left
          .correct-text__label.correct-text__label_small.tablet-hidden Page Title
        .correct-text__column.correct-text__column_right
          .correct-text__field
            .correct-text__field-head.flex.flex_vertical.flex_justify
              .correct-text__field-title.h4 H1 header
              .correct-text__label.correct-text__label_small.min-tablet-hidden Page Title
            form-input.correct-text__input(v-model="content.pageTitle" )
          .correct-text__field
            .correct-text__field-head.flex.flex_vertical.flex_justify
              .correct-text__field-title.h4 H2 header
            form-input.correct-text__input(:value="content.title")

    correct-text-support-item.correct-text__box(
